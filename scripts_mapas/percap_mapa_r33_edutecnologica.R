...
# El fondo comienza en 2009
r33_edutecnologica  <- subset(r33_edutecnologica, r33_edutecnologica$year >= 1999)
var  <- r33_edutecnologica
fileName  <- "r33_edutecnologica_percap"
...
l  <-  c("[0-31)","[31-41)","[41-47)","[47-63)","[63-97]")
