...
# Esta parte del script produce un mapa interactivo .html para r33_faeb_percapita
# Definir var para no tener que hacer cambios en el resto del script
var  <- r33_faeb
fileName  <- "r33_faeb_percap"
...
l  <-  c("[0-1,926)","[1,926-2,201)","[2,201-2,447)","[2,447-2,942)","[2,942-4,046]")
