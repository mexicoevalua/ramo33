...
# Esta parte del script produce un mapa interactivo .html para r33_fortaestados
# Definir var para no tener que hacer cambios en el resto del script
# El fondo r33_edutecnologica comienza en 2007
r33_fortaestados  <- subset(r33_fortaestados,r33_fortaestados$year > 2006)
table(r33_fortaestados$year)
var  <- r33_fortaestados
fileName  <- "r33_fortaestados"
...
l  <-  c("[122 - 261)","[261 - 450)","[450 - 650)","[650 - 965)","[965 - 3,634]")
...
d1$setTemplate(chartDiv = "
               ...
               <input id='slider' type='range' min=2007 max=2014 ng-model='year' width=200>
