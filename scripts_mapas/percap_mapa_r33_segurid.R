...
# Esta parte del script produce un mapa interactivo .html para r33_total
# Definir var para no tener que hacer cambios en el resto del script
# El fondo comienza en 1999
r33_segurid  <- subset(r33_segurid, r33_segurid$year >= 1999)
var  <- r33_segurid
fileName  <- "r33_segurid_percap"
...
l  <-  c("[0-40)","[40-55)","[55-69)","[69-96)","[96-409]")
