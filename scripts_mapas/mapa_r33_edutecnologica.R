...
# Esta parte del script produce un mapa interactivo .html para r33_edutecnologica
# Definir var para no tener que hacer cambios en el resto del script
# El fondo r33_edutecnologica comienza en 1999
r33_edutecnologica  <- subset(r33_edutecnologica,r33_edutecnologica$year > 1998)
table(r33_edutecnologica$year)
var  <- r33_edutecnologica
fileName  <- "r33_edutecnologica"
...
l  <-  c("[0 - 60)","[60 - 87)","[87 - 131)","[131 - 181)","[181 - 632]")
