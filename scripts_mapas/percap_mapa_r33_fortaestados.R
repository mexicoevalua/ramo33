...
# Esta parte del script produce un mapa interactivo .html para r33_fortaestados_percapita
# Definir var para no tener que hacer cambios en el resto del script
# El fondo comienza en 2007

r33_fortaestados  <- subset(r33_fortaestados, r33_fortaestados$year >= 2007)
var  <- r33_fortaestados
fileName  <- "r33_fortaestados_percap"
...
l  <-  c("[118-172)","[172-188)","[188-209)","[209-232)","[232-293]")
